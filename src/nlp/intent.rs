...
pub enum CategoriaIntencion {
    ...
    Buscar,
    Exportar,
    // Intenciones financieras (Fase 5)
    RegistrarGasto,
    RegistrarIngreso,
    ConsultarGastos,
    PedirSugerenciaPago,
...
impl CategoriaIntencion {
    pub fn nombre(&self) -> &str {
        match self {
            ...
            Self::RegistrarGasto => "RegistrarGasto",
            Self::RegistrarIngreso => "RegistrarIngreso",
            ...
            Self::CrearTarea => "CrearTarea",
            Self::ConsultarTareas => "ConsultarTareas",
            Self::CompletarTarea => "CompletarTarea",
            Self::CrearEvento => "CrearEvento",
            Self::CalcularFecha => "CalcularFecha",
            Self::CrearRecuerdo => "CrearRecuerdo",
            Self::BuscarMemoria => "BuscarMemoria",
            Self::GenerarPassword => "GenerarPassword",
